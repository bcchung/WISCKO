    ...
    <div id="rightcontent_wrap">
        <div id="download_div">
            ...
            <ol>
                ...
                <!--
                <li><img src="<c:url value='/'/>images/header/num01.gif" alt="" />egovframework install shield v3.01</li> 
                <li><img src="<c:url value='/'/>images/header/num10.gif" alt="" />egovframework install shield v3.01</li>
                 -->
            </ol>
        </div>
        <div id="banner_div">
            <div class="bnpadtop"><img src="http://www.google.co.kr${result.icon}"> 서울날씨:${result.condition}, 온도:${result.temp_c}, ${result.humidity}</div>
            <div class="bnpadding"><a href="http://www.mopas.go.kr/" target="_blank"><img src="<c:url value='/'/>images/header/banner_mopas.gif" alt="행정안전부" /></a></div>
            <div class="bnpadding"><a href="http://www.nia.or.kr/" target="_blank"><img src="<c:url value='/'/>images/header/banner_nia.gif" alt="한국정보화진흥원" /></a></div>
