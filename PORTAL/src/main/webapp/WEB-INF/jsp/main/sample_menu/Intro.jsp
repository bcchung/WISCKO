...
- 포탈사이트 템플릿은 공통컴포넌트를 기반으로 아래 그림과 같이 메뉴가 구성됩니다.
- 관리자로 로그인하면 관리자용 메뉴를 추가로 사용할 수 있습니다.
- 기울임체로 표시된 메뉴는 구성을 위한 샘플페이지가 제공되며 기능은 구현되지 않은 상태입니다.
</pre>
<br>
<img src="<c:url value='/images/menu_pst.jpg'/>" alt="포탈사이트 홈페이지 메뉴구성">

<br>
<a href="http://www.egovframe.org/wiki/doku.php?id=egovframework:let" target="_blank">
