<%--
  ...
  Description : EgovCcmZipSearchPopup 화면(system)
...
-->
<!-- FIREFOX -->
<iframe name="ifcal" title="우편번호 찾기" src="<c:url value='/sym/cmm/EgovCcmZipSearchList.do'/>" style="width:560px; height:340px;" frameborder="0"></iframe>
</body>
</html>