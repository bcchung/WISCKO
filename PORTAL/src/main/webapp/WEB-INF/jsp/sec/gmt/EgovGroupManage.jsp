        ...
        <div id="middle_content">
            ...
            <div class="search_service">
                ...
                <div class="search_conditions" >그룹 명 : 
                    <input name="searchKeyword" type="text" value="<c:out value='${groupManageVO.searchKeyword}'/>" size="25" title="검색" onkeypress="press();" />        
                </div>
            ...
            <div class="search_result_div">
                ...
                <tr>
				    ...
				    <td><a href="#LINK" onclick="javascript:fncSelectGroup('<c:out value="${group.groupId}"/>')"><c:out value="${group.groupId}"/></a></td>
				    <td><c:out value="${group.groupNm}"/></td>
				    <td><c:out value="${group.groupDc}"/></td>
				    <td><c:out value="${group.groupCreatDe}"/></td>
				    <td><a href="#LINK" onclick="javascript:fncSelectGroup('<c:out value="${group.groupId}"/>')"><img src="<c:url value='/images/img_search.gif'/>" width="15" height="15" align="middle" alt="상세조회"></a></td>           
                </tr>   
                </c:forEach>
                </tbody>
