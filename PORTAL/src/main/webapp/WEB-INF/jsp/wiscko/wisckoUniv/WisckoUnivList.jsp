...
function fn_egov_selectSearch(univId) {
...
<div class="search_service">
	<div class="search_area">
		<div class="search_conditions">
			<label for="searchCondition">검색유형선택</label> <select name="searchCondition" class="select" title="검색유형선력">
				<option value="0" <c:if test="${searchVO.searchCondition == '0'}">selected="selected"</c:if>>대학명</option>
			</select> <label for="searchKeyword">검색어</label>
			<%-- <input name="searchKeyword" type="text" value="${searchVO.searchKeyword}"/> --%>
			<form:input path="searchKeyword" />
		</div>
		<div class="search_buttons">
			<input type="submit" value="<spring:message code="button.inquire" />"
				onclick="fn_egov_selectSearch(); return false;"/>
			<a href="<c:url value='/wiscko/wisckoUniv/addWisckoUnivView.do'/>" onclick="fn_egov_addView(); return false;"><spring:message
