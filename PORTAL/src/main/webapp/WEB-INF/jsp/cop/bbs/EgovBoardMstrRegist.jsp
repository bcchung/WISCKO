				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<td class="td_width"><label for="bbsNm"> <spring:message
									code="cop.bbsNm" />
						</label> <img src="<c:url value='/'/>images/required.gif" alt="필수항목"
							title="필수항목" width="15" height="15" /></td>
						<td class="td_content" colspan="3"><form:input
								title="게시판명입력" path="bbsNm" size="60" /> <br /> <form:errors
								path="bbsNm" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="td_content"><form:select path="bbsTyCode"
								...
								<form:options items="${typeList}" itemValue="code"
									itemLabel="codeNm" />
							</form:select> <br /> <form:errors path="bbsTyCode" /></td>
						<td class="td_width"><label for="bbsAttrbCode"> <spring:message
									code="cop.bbsAttrbCode" />
						</label> <img src="<c:url value='/'/>images/required.gif" alt="필수항목"
							title="필수항목" width="15" height="15" /></td>
						<td class="td_content"><form:select path="bbsAttrbCode"
								...
								<form:options items="${attrbList}" itemValue="code"
									itemLabel="codeNm" />
							</form:select> <br /> <form:errors path="bbsAttrbCode" /></td>
					</tr>

					<tr>
						<td class="td_width"><label for="replyPosblAt"> <spring:message
									code="cop.replyPosblAt" />
						</label> <img src="<c:url value='/'/>images/required.gif" alt="필수항목"
							title="필수항목" width="15" height="15" /></td>
						<td class="td_content"><spring:message
								code="button.possible" /> : <form:radiobutton
								path="replyPosblAt" value="Y" />&nbsp; <spring:message
								code="button.impossible" /> : <form:radiobutton
								path="replyPosblAt" value="N" /> <br /> <form:errors
								path="replyPosblAt" /></td>
						<td class="td_width"><label for="fileAtchPosblAt"> <spring:message
									code="cop.fileAtchPosblAt" />
						</label> <img src="<c:url value='/'/>images/required.gif" alt="필수항목"
							title="필수항목" width="15" height="15" /></td>
						<td class="td_content"><spring:message
								code="button.possible" /> : <form:radiobutton
								path="fileAtchPosblAt" value="Y"
								onclick="document.boardMaster.posblAtchFileNumber.disabled='';" />&nbsp;
							<spring:message code="button.impossible" /> : <form:radiobutton
								path="fileAtchPosblAt" value="N"
								onclick="document.boardMaster.posblAtchFileNumber.disabled='disabled';" />
							<br /> <form:errors path="fileAtchPosblAt" /></td>
					</tr>

					<tr>
						<td class="td_width"><label for="posblAtchFileNumber">
						...
						<td class="td_content" colspan="3"><form:select
							...
							</form:select> <br /> <form:errors path="posblAtchFileNumber" /></td>
					</tr>
					<tr>
						<td class="td_width"><label for="tmplatNm"> <spring:message
							...
							title="필수항목" width="15" height="15" /></td>
						<td class="td_content" colspan="3"><form:input
								path="tmplatNm" size="20" readonly="true" title="템플릿정보입력" /> <form:hidden
							...
							style="selector-dummy: expression(this.hideFocus =   false);"><img
								...
								height="15" align="middle" alt="새창" /></a> <br /> <form:errors
								path="tmplatId" /></td>
					</tr>
				...
				<td>
					<div class="buttons" align="center" style="margin-bottom: 100px">
						...
						<input type="submit"
							...
							onclick="fn_egov_select_brdMstrList(); return false;" />
					</div>
				</td>
			</tr>
		</table>
