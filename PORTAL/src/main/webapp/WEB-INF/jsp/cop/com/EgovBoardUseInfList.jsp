    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
            ...
            <div class="search_result_div">
                ...
                <table width="98%" cellpadding="0" cellspacing="0" summary="번호,게시판명,사용 커뮤니티 명,사용 동호회 명,등록일시,사용여부   목록입니다">
			...
			<div align="center"><ul class="paging_align">
