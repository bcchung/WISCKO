...
<div id="wrap"> 
    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
			...
			<!-- 상단타이틀 -->
			<form:form commandName="qnaManageVO" name="qnaManageVO" action="${pageContext.request.contextPath}/uss/olh/qna/QnaCnRegist.do" method="post" > 
			<input name="answerCn" type="hidden" value="Testing...">

            <!-- sub title start -->
            <div><h2>Q&amp;A내용등록</h2></div>
            <!-- sub title end -->
            ...
            <div class="search_service">
                <div class="search_top_table">
					...
					<caption>Q&amp;A내용등록</caption>
					  ...
					  <tr> 
					    <td class="td_width"><label for="writngPassword">작성 비밀번호</label><img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></td>
					    <td class="td_content">
            ...
            <div class="buttons" align="center" style="margin-bottom:100px">
		        <input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_regist_qnacn(document.qnaManageVO); return false;" />
