                ...
                <div class="search_top_table">                  
					...
					<caption>FAQ상세조회</caption>
					  ...
					  <tr> 
					    ...
					    <td class="td_content">
					      <textarea name="qestnCn" class="textarea"  cols="100" rows="15"  readonly="readonly" title="질문내용"><c:out value="${result.qestnCn}"/>
					      </textarea>
					    </td>
					  </tr>
					  ...
					  <tr> 
					    ...
					    <td class="td_content">
					      <textarea name="answerCn" class="textarea"  cols="100" rows="15" readonly="readonly" title="답변내용"><c:out value="${result.answerCn}"/>
					      </textarea>
					    </td>
					  </tr>
