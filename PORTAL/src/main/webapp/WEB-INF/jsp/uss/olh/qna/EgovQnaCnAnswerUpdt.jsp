                ...
                <div class="search_top_table">                  
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="Q&amp;A에 대한 답변을 수정합니다.">
					  ...
					  <tr> 
					    ...
					    <td class="td_content">    
					      <textarea name="qestnCn" class="textarea"  cols="95" rows="10"  readonly="readonly" title="질문내용"><c:out value="${result.qestnCn}"/>
					      </textarea>                                      
					    </td>
					  </tr> 
					    ...
					    <td class="td_content">
					        <select name="qnaProcessSttusCode" class="select" title="진행처리상태">
					            <c:forEach var="forResult" items="${resultList}" varStatus="status">
					                <option value='<c:out value="${forResult.code}"/>'               
					                <c:if test="${forResult.code == result.qnaProcessSttusCode}">selected="selected"</c:if>
					                >
