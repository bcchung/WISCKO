                ...
                <div class="search_top_table">                  
                    <table summary="이 표는 개인정보보호정책 상세정보를 제공합니다.">
                        ...
                        <tr>
                            ...
                            <td class="td_content">
                                <textarea id="indvdlInfoDc" name="indvdlInfoDc" title="개인정보보호정책 내용" rows="20" cols="100" 
                                          readonly="readonly" /><c:out value="${indvdlInfoPolicy.indvdlInfoDc}" escapeXml="false" /></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >개인정보보호정책 명<img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="80%">
		 <c:out value="${indvdlInfoPolicy.indvdlInfoNm}" />
    </td>
  </tr>  
  ...
  <tr> 
    <th height="23" class="required_text" >동의여부<img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
    <c:if test="${indvdlInfoPolicy.indvdlInfoYn == 'Y'}">예</c:if>
    <c:if test="${indvdlInfoPolicy.indvdlInfoYn == 'N'}">아니오</c:if>
    </td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >개인정보보호정책  내용<img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="80%">
