    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
            ...
            <div class="search_result_div">
                ...
                <thead>
                <tr>      
                    <th scope="col" class="title" width="35px" nowrap="nowrap">순번</th>
				    <th scope="col" class="title" nowrap="nowrap">질문내용</th>
				    <th scope="col" class="title" width="70px" nowrap="nowrap">질문유형</th>
				    <th scope="col" class="title" width="70px" nowrap="nowrap">질문항목</th>
				    <th scope="col" class="title" width="50px" nowrap="nowrap">통계</th>
				    <th scope="col" class="title" width="70px" nowrap="nowrap">등록자</th>   
				    <th scope="col" class="title" width="70px" nowrap="nowrap">등록일자</th>
                </tr>
                </thead>
