                ...
                <div class="search_top_table">
                    <table summary="이 표는 설문조사 대상 정보를 제공하며, 설문관리정보, 설문문항정보, 설문유형, 성문항목정보, 응답자답변내용, 기타답변내용, 응답자명 정보로 구성되어 있습니다 .">
					  ...
					  <tr> 
					    ...
					    <td class="td_content">
					        <input name="qustnrIemCn" id="qustnrIemCn" type="text" title="설문문항정보" size="73" value="${resultList[0].iemCn}" maxlength="4000" style="width:300px;">
					         <a href="#LINK" onClick="fn_egov_QustnrItemManageListPopup_QustnrItemManage()">         
					        <img src="<c:url value='/images/img_search.gif'/>" alt="설문항목정보" title="새창">
					        </a>
