        ...
        <div id="middle_content">
            ...
            <div class="search_result_div">
				...
				<tr>
				    ...
				    <td class="lt_text3">
				        <img src="/pst/uss/olp/qtm/EgovQustnrTmplatManageImg.do?qestnrTmplatId=${resultInfo.qestnrTmplatId}" alt="${resultInfo.qestnrTmplatTy}템플릿이미지" title="${resultInfo.qestnrTmplatTy}템플릿이미지">
				    </td>
