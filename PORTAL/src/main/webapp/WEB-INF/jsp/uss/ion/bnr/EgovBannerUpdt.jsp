    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
                ...
                <div class="search_top_table">                  
				  ...
				  <tr>
				    ...
				    <td class="td_content">
				        ...
				        <input name="bannerImage" id="bannerImage" type="text" title="배너이미지" value="<c:out value="${banner.bannerImage}"/>" maxLength="30" size="30" class="readOnlyClass" readonly="readonly" / >
					    </td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td class="td_content"><input name="sortOrdr" id="sortOrdr" title="정렬순서" type="text" value="<c:out value='${banner.sortOrdr}'/>" maxLength="5" size="10" >&nbsp;<form:errors path="sortOrdr" /></td>
					  </tr>    
					  <tr>
					  ...
					  <tr>
					    ...
					    <td class="td_content"><input name="regDate" id="regDate" title="등록일시" type="text" value="<c:out value="${banner.regDate}"/>" maxLength="50" size="20" class="readOnlyClass" readonly="readonly"></td>
					  </tr>
					</table>
                </div>
            </div>
            ...
            <div class="buttons" align="center" style="margin-bottom:100px">
                <input type="submit" value="<spring:message code="button.save" />" onclick="fncBannerUpdate(); return false;">
                <a href="<c:url value='/uss/ion/bnr/removeBanner.do'/>?bannerId=<c:out value='${bannerVO.bannerId}'/>" onclick="fncBannerDelete(); return false;"><spring:message code="button.delete" /></a>
