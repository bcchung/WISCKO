...
function updateProgramListManage() {
	var frm = document.progrmManageVO;
	
	if(confirm("<spring:message code="common.save.msg" />")){
		if(!validateProgrmManageVO(frm)){
			return;
		}else{
			frm.action="<c:url value='/sym/prm/EgovProgramListDetailSelectUpdt.do' />";
			frm.submit();
		}
	}
}
...
function deleteProgramListManage() {
	...
	if(confirm("<spring:message code="common.delete.msg" />")){
		frm.action="<c:url value='/sym/prm/EgovProgramListManageDelete.do' />";
		frm.submit();
	}
}
...
<form:form commandName="progrmManageVO" id="progrmManageVO" name="progrmManageVO" method="post">
<DIV id= "main">
  ...
  <tr>
    <td>
		...
		<tr>
          ...
          <td width="5%"></td>
          <td><span class="button"><input type="submit" value="<spring:message code="button.update" />" onclick="updateProgramListManage(); return false;"></span></td>
          <td width="5%"></td>
          <td><span class="button"><a href="<c:url value='/sym/prm/EgovProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(); return false;"><spring:message code="button.delete" /></a></span></td>
		</tr>
		</table>
    </td>
  </tr>
