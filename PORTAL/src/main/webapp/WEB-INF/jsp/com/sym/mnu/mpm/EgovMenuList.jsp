...
function fn_selectMenuList() {
    document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/EgovMenuListMange.do'/>";
    document.menuManageVO.submit();
}
...
function fn_goLocaleMenu(locale){
	$j("#locale").val(locale);
...
<body>
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form:form commandName="searchVO" name="menuManageVO" id="menuManageVO" action="<c:url value='/sym/mnu/mpm/EgovMenuListInsert.do'/>" method="post">
	...
	<input type="hidden" name="locale" id="locale" value="${searchVO.locale}">

<table width="100%" cellpadding="8" class="table-search" border="0">
	<tr>
		<td class="title_left">
			<h1>
				<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;메뉴 목록
			</h1>
		</td>
	</tr>
	<tr>
		<td class="title_left">
			<c:forEach var="result" items="${localeTcList}" varStatus="status">
				<input type="radio" name="localeRdo" value="${result.code}"
					 <c:if test="${searchVO.locale==result.code}">checked="checked"</c:if>
					 onclick="javascript:fn_goLocaleMenu('${result.code}');"/>${result.codeNm}
			</c:forEach>
		</td>
	</tr>
</table>
<table width="100%" cellpadding="8" class="table-search" border="0">
	<tr>
		<td width="240" class="title_left" rowspan='2'>
			...
			<!-- <div class="tree" style="position: absolute; left: 100px; top: 160px; width: 240px; height: 500px; z-index: 10;"> -->
			<div class="tree" style="vleft: 100px; top: 160px; width: 240px; height: 6s00px; z-index: 10;">
		...
		<td width="*" class="title_left">
			<span class="button">
				<a href="<c:url value='/sym/mnu/mpm/EgovMenuListSelect.do'/>" onclick="initlMenuList(); return false;">초기화</a>
			</span>
			<span class="button">
				<input type="submit" value="<spring:message code="button.save" />" onclick="insertMenuList(); return false;">
			</span>
			<span class="button">
				<a href="#LINK" onclick="updateMenuList(); return false;"><spring:message code="button.update"/></a>
			</span>
			<span class="button">
				<a href="#LINK" onclick="deleteMenuList(); return false;"><spring:message code="button.delete"/></a>
			</span>
		</td>
	</tr>
	<tr>
		<td width="70%" class="title_left">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="메뉴리스트정보">
				...
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="menuNo">메뉴No</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="menuNo" type="text" size="10" value="" maxlength="10" title="메뉴No">
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="menuOrdr">메뉴순서</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="menuOrdr" type="text" size="10" value="" maxlength="10" title="메뉴순서">
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="menuNm">메뉴명</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="menuNm" type="text" size="30" value="" maxlength="30"
						title="메뉴명">
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="upperMenuId">상위메뉴No</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="upperMenuId" type="text" size="10" value="" maxlength="10" title="상위메뉴No">
						<a href="/sym/mnu/mpm/EgovMenuListSelectMvmn.do" target="_blank" title="새창으로" onClick="mvmnMenuList();return false;" style="selector-dummy: expression(this.hideFocus = false);">
							<img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />" alt='' width="15" height="15" />(메뉴선택검색)</a>
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="progrmFileNm">파일명</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="progrmFileNm" type="text" size="30" value="" maxlength="60"
						title="파일명">
						<a href="/sym/prm/EgovProgramListSearch.do" target="_blank" title="새창으로" onClick="searchFileNm();return false;" style="selector-dummy: expression(this.hideFocus = false);">
							<img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />" alt='' width="15" height="15" />(프로그램파일명검색)</a>
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="relateImageNm">관련이미지명</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="relateImageNm" type="text" size="30" value="" maxlength="30" title="관련이미지명">
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="relateImagePath">관련이미지경로</label><img
						src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
					<td width="70%" nowrap>&nbsp; <input name="relateImagePath" type="text" size="30" value="" maxlength="60" title="관련이미지경로">
					</td>
				</tr>
				<tr>
					<th width="30%" height="23" class="required_text" scope="row"><label for="menuDc">메뉴설명</label></th>
					<td width="70%">&nbsp; <textarea name="menuDc" class="textarea" cols="45" rows="8" style="width: 350px;" title="메뉴설명"></textarea>
					</td>
				</tr>
			</table>
