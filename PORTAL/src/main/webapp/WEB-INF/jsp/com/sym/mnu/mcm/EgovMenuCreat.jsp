...
/* Image Path 설정 */
/*   String imagePath_icon   = "${pageContext.request.contextPath}/images/egovframework/com/sym/mnu/mcm/icon/";
...
function fInsertMenuCreat() {
    ...
    document.menuCreatManageForm.checkedLocaleForInsert.value=document.menuCreatManageForm.locale.value;
...
<form name="menuCreatManageForm" action="<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.do' />" method="post">
	...
	<input name="checkedLocaleForInsert" type="hidden">
...
<table width="100%" cellpadding="8" class="table-search" border="0">
	<tr>
		<td width="30%" class="title_left">
			<h1>
				<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" alt="">&nbsp;메뉴생성
			</h1>
		</td>
		<td width="10%"></td>
		<td width="25%"></td>
		<th width="35%">
			<span class="button"><a href="#LINK" onclick="fInsertMenuCreat(); return false;">메뉴생성</a></span>
			<!-- <span class="button"><input type="submit" value="사이트맵생성" onclick="fMenuCreatSiteMap(); return false;"></span> -->
			<span class="button"><a href="#LINK" onclick="selectMenuCreatManageList(); return false;">목록</a></span>
		</th>
	</tr>
</table>
		...
		<td width="100%">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="메뉴생성 검색조건">
				...
				<tr>
					...
					<td width="85%">
						<input name="authorCode" type="text" size="30" maxlength="30" title="권한코드" value="${resultVO.authorCode}" readonly/>
						<input name="locale" type="text" title="국가코드" value="${resultVO.locale}" readonly/>
					</td>
				</tr>
			</table>
		</td>
...
<table width="100%" cellpadding="8" class="table-line" summary="메뉴일괄등록">
