...
public interface EgovMenuCreateManageService {
	 ...
	 * @param checkedMenuNoForInsert2 
	 * @exception Exception
	 */
	void insertMenuCreatList(String checkedLocaleForInsert,String checkedScrtyForInsert, String checkedMenuNoForInsert) throws Exception;
