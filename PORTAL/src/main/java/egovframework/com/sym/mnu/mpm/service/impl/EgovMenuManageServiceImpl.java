...
public class EgovMenuManageServiceImpl extends AbstractServiceImpl implements EgovMenuManageService{
	 ...
	 * @exception Exception
	 */
	public List selectMenuList(ComDefaultVO searchVO) throws Exception {
   		return menuManageDAO.selectMenuList(searchVO);
	}
