...
public class EgovMenuCreateManageController {
	...
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model)
		...
		return "com/sym/mnu/mcm/EgovMenuCreatManage";
	}
	...
	public String selectMenuCreatList(@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO, ModelMap model)
		...
		return "com/sym/mnu/mcm/EgovMenuCreat";
	}
	...
	public String insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert,
			...
			@RequestParam("checkedLocaleForInsert") String checkedLocaleForInsert,
		...
		if (insertMenuNo == null || (insertMenuNo.length == 0)) {
			...
			menuCreateManageService.insertMenuCreatList(checkedLocaleForInsert, checkedAuthorForInsert, checkedMenuNoForInsert);
	...
	public String selectMenuCreatSiteMap(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, ModelMap model)
		...
		return "com/sym/mnu/mcm/EgovMenuCreatSiteMap";
	}
	...
	public String selectMenuCreatSiteMapInsert(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO,
			@RequestParam("valueHtml") String valueHtml, ModelMap model) throws Exception {
		...
		menuSiteMapVO.setTmpRootPath(EgovProperties.RELATIVE_PATH_PREFIX + ".." + System.getProperty("file.separator")
	...
	public String selectSiteMap(@ModelAttribute("menuCreatVO") MenuSiteMapVO menuSiteMapVO, ModelMap model)
		...
		model.addAttribute("resultVO", menuSiteMapVO);
		return "com/sym/mnu/mcm/EgovSiteMap";
	}
