...
public class EgovMenuManageController {
	...
	@Resource(name = "ComMenuManageService")
...
//    private EgovExcelService excelZipService;
    ...
    public String selectMenuManage(
        ...
        return "com/sym/mnu/mpm/EgovMenuDetailSelectUpdt";
    }
    ...
    public String selectMenuManageList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "com/sym/mnu/mpm/EgovMenuManage";
    }
    ...
    public String insertMenuManage(
		...
		if(sCmd.equals("insert")){
    		...
    		if (bindingResult.hasErrors()){
    			sLocationUrl = "com/sym/mnu/mpm/EgovMenuRegist";
    			return sLocationUrl;
    		}
    ...
    public String selectMenuList(
    	...
    	List list_menulist = menuManageService.selectMenuList(searchVO);
        ...
        /** 코드 조회 **/
      	...
      	return  "com/sym/mnu/mpm/EgovMenuList";
    }
    ...
    public String insertMenuList(
        ...
        beanValidator.validate(menuManageVO, bindingResult);
		if (bindingResult.hasErrors()){
			sLocationUrl = "com/sym/mnu/mpm/EgovMenuList";
			return sLocationUrl;
		}
    ...
    public String selectMenuListMvmn(
    	...
    	List list_menulist = menuManageService.selectMenuList(searchVO);
        model.addAttribute("list_menulist", list_menulist);
      	return  "com/sym/mnu/mpm/EgovMenuMvmn";
    }
    ...
    public String menuBndeAllDelete(
    	...
    	resultMsg = egovMessageSource.getMessage("success.common.delete");
    	model.addAttribute("resultMsg", resultMsg);
        return "com/sym/mnu/mpm/EgovMenuBndeRegist";
    }
    ...
    public String menuBndeRegist(
        ...
        if(sCmd.equals("bndeInsert")){
			...
			sLocationUrl = "com/sym/mnu/mpm/EgovMenuBndeRegist";
	    	model.addAttribute("resultMsg", resultMsg);
        }else{
            sLocationUrl = "com/sym/mnu/mpm/EgovMenuBndeRegist";
        }
