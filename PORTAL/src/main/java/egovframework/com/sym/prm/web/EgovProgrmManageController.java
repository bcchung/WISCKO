...
//    private EgovSndngMailRegistService sndngMailRegistService;
    ...
    public String selectProgrm(
        ...
        return "com/sym/prm/EgovProgramListDetailSelectUpdt";
    }
    ...
    public String selectProgrmList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "com/sym/prm/EgovProgramListManage";
    ...
    public String insertProgrmList(
        ...
        if(sCmd.equals("insert")){
			...
			if (bindingResult.hasErrors()){
				sLocationUrl = "com/sym/prm/EgovProgramListRegist";
				return sLocationUrl;
			}
    ...
    public String selectProgrmChangeRequstList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
         ...
         return "com/sym/prm/EgovProgramChangeRequst";
    }
    ...
    public String selectProgrmChangeRequst(
         ...
         return "com/sym/prm/EgovProgramChangRequstDetailSelectUpdt";
    }
    ...
    public String insertProgrmChangeRequst(
        ...
        if(sCmd.equals("insert")){
			...
			if (bindingResult.hasErrors()){
				sLocationUrl = "com/sym/prm/EgovProgramChangRequstStre";
				return sLocationUrl;
			}
    ...
    public String selectProgrmChangeRequstProcessList(
         ...
         return "com/sym/prm/EgovProgramChangeRequstProcess";
    }
    ...
    public String selectProgrmChangRequstProcess(
         ...
         model.addAttribute("progrmManageDtlVO", resultVO);
         return "com/sym/prm/EgovProgramChangRequstProcessDetailSelectUpdt";
    }    
...
//	    	result = sndngMailRegistService.insertSndngMail(sndngMailVO); 
    ...
    public String selectProgrmChgHstList(
         ...
         return "com/sym/prm/EgovProgramChgHst";
    } 
    ...
    public String selectProgramChgHstListDetail(
         ...
         return "com/sym/prm/EgovProgramChgHstDetail";
    }
    ...
    public String selectProgrmListSearch(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "com/sym/prm/EgovFileNmSearch";
